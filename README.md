...
- [x] 상품명 가격 수량 입력 받기
  - [x] 금액과, 수량 숫자가 아닌 경우 예외처리
  - [x] 지정된 형식과 일치 하지 않으면 예외처리


- [ ] 투입금액 입력받기
  - [ ] 숫자가 아닌경우 예외처리
  - [ ] 10원단위로 나눠 떨어지지 않을경우 예외 처리


- [ ] 구매할 상품명 입력받기 
  - [ ] 구매할 상품이 존재하지 않을 경우 예외처리
  - [ ] 투입금액이 구매할 상품보다 적을 경우 예외처리


- [ ] 구매성공 후 남은 금액 출력


- [ ] 더이상 구매 할 수 없을 경우 잔돈 반환
